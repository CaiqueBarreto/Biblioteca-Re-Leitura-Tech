        ...
        do
        {
            ...
            if(pagamento1 == true)
            {
                ...
                else if(quantidadelivro == 2) //Dois livros no carrinho
                {
                    ...
                    if(exclui == 2) // ÃƒÂREA DE PAGAMENTO
                    {   
                        if(exclui == 2 && quantidadelivro == 1 && lixo[0] == 1) //1 livro no carrinho apÃƒÂ³s excluir
                        {
                            printf("------------------------------------------------------");
                            printf("\n|                    PAGAMENTO                       |\n");
                            printf("------------------------------------------------------\n");
                        ...
                        else if(exclui == 2 && quantidadelivro == 1 && lixo[0] == 2) //1 livro no carrinho apÃƒÂ³s excluir
                        {
                            printf("------------------------------------------------------");
                            printf("\n|                    PAGAMENTO                       |\n");
                            printf("------------------------------------------------------\n");
                        ...
                        else if(lixo[0] != 1 || lixo[0] != 2) //2 Livros no carrinho nÃƒÂ£o excluindo do carrinho
                        {
                            printf("------------------------------------------------------");
                            printf("\n|                    PAGAMENTO                       |\n");
                            printf("------------------------------------------------------\n");
                ...
                else if(quantidadelivro == 3) //Tres livros no carrinho
                {
                    ...
                    if(exclui == 2) //NÃƒÂ£o excluindo item do carrinho
                    {
